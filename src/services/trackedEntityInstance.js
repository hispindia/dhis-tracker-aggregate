export const trackedEntityInstance = {
  get: async (tei, program) => {
    var url = `${process.env.REACT_APP_DHIS2_BASE_URL}/api/trackedEntityInstances/${tei}.json?paging=false&fields=orgUnit,trackedEntityInstance,attributes[attribute,value],enrollments[events[programStage,orgUnit,eventDate,dataValues[dataElement,value]]]&program=${program}`
